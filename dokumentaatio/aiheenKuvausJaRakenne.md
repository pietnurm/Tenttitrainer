...
## Rakennekuvaus
Ylläoleva luokkakaavio ei ole täysin ajantasainen, mutta en sitä kurssin puitteissa ehdi enää päivittää. 
Käyttäjä käyttää ohjelmaa Käyttöliittymä-luokan kautta. Eri näkymien välillä siirrytään Java Swingin CardLayoutin avulla. Lisäksi Kysymysten luomisessa käytetään erillistä kysymyseditori-luokkaa ja kysymysten tenttaamisessa omaa Tenttinakyma-luokkaa. 
Sovelluslogiikassa on omat luokkansa kysymykselle ja kategorialle. Kysymys-luokka huolehtii yksittäisten kysymysten toiminnallisuudesta sekä mm. tiedostoon tallentamisesta. Kaikkea Kysymys-luokan toiminnallisuutta ei vielä tueta. Kategoria-luokka pitää sisällään yhteen kategoriaan kuuluvat kysymykset. Se hakee tiedostosta aiemmin samannimiseen kategoriaan tallennetut kysymykset ja ylläpitää tiedostoa, johon on listattu kaikki tallennetut kategoriat. Kaikkea Kategorian toiminnallisuutta ei vielä tueta. Sovelluslogiikan tärkeimpiä luokkia on Kysymysvarasto. Sen avulla voidaan lukea tiedostoista ja palauttaa kaikki aiemmin tallennetut kategoriat ja kysymykset. Alakategoria-luokkaa ei käytetä, koska sen toiminnallisuutta ei vielä tueta.
Testi-luokan avulla käyttäjä voi tentata itseltään tallennettuja kysymyksiä. Konstruktorin parametreista riippuen voidaan testata joko kaikkia kysymyksiä tai yhden kategorian kysymyksiä. Testi-luokka luo satunnaistetun kysymyslistan valinnan perusteella ja tarjoaa toiminnallisuuden mm. kysymysten ja mallivastausten palauttamiseen sekä vastausten arvosteluun ja arvostelujen palauttamiseen. Alakategorian testaamisen toiminnallisuus löytyy osittain, mutta sitä ei vielä tueta.
Tulosarkisto tallentaa Testi-luokan kysymysten arvosteluja tiedostoihin ja palauttaa mm pistesaldot ja kokonaiskeskiarvon. Kategoriakeskiarvot palautetaan taulukkomuodossa Käyttöliittymän tulokset-cardin luettavaksi.
